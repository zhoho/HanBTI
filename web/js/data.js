...
const info_list = [
    ...
    {
        name : '한동 박사님',
        desc : '비평적인 관점을 가진 뛰어난 전략을 가진 사람이에요.',
        club : 'CRA, 청소년 자유학교',
        match : '한동 경찰관, 한동 지휘자',
        place : '기숙사, 방'
    },
    ...
    {
        name : '한동 재주꾼',
        desc : '논리적이고 뛰어난 상황 적응력을 가진 사람이에요.',
    ...
    {
        name : '한동 토론왕',
        desc : '풍부한 상상력으로 새로운 것에 도전하는 사람이에요.',
        club : '할루시네이션, 한검',
        match : '한동 츤데레, 한동 전략가',
        place : '오석'
    },
    {
        name : '한동 지휘자',
        desc : '비전을 갖고 타인을 활력적으로 인도하는 사람이에요.',
        club : "GO, 천풍해세",
        match : '한동 열정맨, 한동 박사님',
        place : '오석'
    },
    ...
    {
        name : '한동 외교관',
        desc : '친절, 현실감을 바탕으로 타인에게 봉사하는 사람이에요.',
        club : "레버리, 소울",
        match : '한동 예술가, 한동 재주꾼',
        place : '동아리방'
    },
    {
        name : '한동 사업가',
        desc : '친구, 운동, 음식 등 다양함을 선호하는 사람이에요.',
        club : "CANVAS, VAM",
        match : '한동 수호자, 한동 논리왕',
        place : '양덕, 영일대'
    },
