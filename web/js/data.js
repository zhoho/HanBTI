const qnaList =[
    ...
    {
        q: '4. 교수님께서 과제 제출일을 갑자기 앞당기셨다. 이때 나는?',
        a: [
            {
    ...
    {
        q: '9. 나 동아리 지원했는데 떨어졌어.. 친구가 슬퍼할때 나는?',
        a: [
            {
    ...
    {
        q: '11. 친구가 “ㅇㅇ아 나 우울해서 머리 잘랐다..” 라고 말하면 나는?',
        a: [
            {
    ...
    {
        q: '13. 우리 종강하고 새섬, 새내기끼리 여행갈까? 계획은 어떻게 세울까?',
        a: [
            {
